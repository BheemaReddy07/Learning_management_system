...
const SearchPage = () => {
    ...
    const isEmpty = false;
  return (
    <div className='mt-20 max-w-7xl mx-auto p-4 md:p-8'>
         <div className='my-6'>
            <h1 className='font-bold text-xl md:text-2xl'>Result for the html</h1>
            <p>Showing result for the<span className='font-bold text-blue-800 italic'>  {"  "}Html</span></p>
         </div>
